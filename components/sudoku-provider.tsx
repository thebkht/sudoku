...
type SudokuContextProps = {
     ...
     setTimeGameStarted: React.Dispatch<React.SetStateAction<Date>>,
     fastMode: boolean,
...
const SudokuContext = createContext<SudokuContextProps>({
     ...
     timeGameStarted: new Date(), setTimeGameStarted: () => { },
...
export const SudokuProvider = ({ children }: SudokuProviderProps) => {
     ...
     let [timeGameStarted, setTimeGameStarted] = useState<Date>(new Date());
